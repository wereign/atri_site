...
export function useMenu_BarCb() {
	const onClick = useCallback(callbackFactory("Menu_Bar", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useIntro_BoxCb() {
	const onClick = useCallback(callbackFactory("Intro_Box", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function usepast_projectsCb() {
	const onClick = useCallback(callbackFactory("past_projects", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useCarousel11Cb() {
...
export function useCarousel13Cb() {
...
export function useCarousel14Cb() {
...
export function useCard_ContainerCb() {
	const onClick = useCallback(callbackFactory("Card_Container", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useCarousel16Cb() {
...
export function useCarousel17Cb() {
...
export function useCarousel19Cb() {
...
export function useToggle3Cb() {
	const onChange = useCallback(callbackFactory("Toggle3", "Home", "/", "onChange", 
			{
  "handlers": [
    {
      "sendEventData": true
