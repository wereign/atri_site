...
class Atri:
	...
	@property
	def Toggle3(self):
		self._getter_access_tracker["Toggle3"] = {}
		return self._Toggle3
	@Toggle3.setter
	def Toggle3(self, new_state):
		self._setter_access_tracker["Toggle3"] = {}
		global default_state
		self._Toggle3 = Toggle(new_state, default_state["Toggle3"])
